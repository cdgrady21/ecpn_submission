...
index: inverse-covariance weights ("cw") or additive ("ind").  model: controlling-for ("cont") or differencing ("diff").  Note that not not all outcomes are indices, some outcomes are endline only, and only contact outcomes use count variables.
