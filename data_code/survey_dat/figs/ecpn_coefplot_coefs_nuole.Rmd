...
chris: NUOLE provided alternative way to bootstrap.  Need to see if this solves my asymmetric SEs problem.
...
for (i in 1:R){
  ...
  h[i,] <- b ##chris: pretty sure b also includes intercept, which we dont want
}
...
save(ag.coefs, file="ag.coefs_2.Rdata")
```
...
save(ind.coefs, file="ind.coefs_2.Rdata")
```
