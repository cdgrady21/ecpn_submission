...
all_mean <- c(mean(benPast_tab[1:5,1]), colMeans(benPast_tab[,2:3]))
benPast_tab <- rbind(benPast_tab, all_mean)
...
### contact
contact_none <- p.adjust(commListPs[c(3,4,8:10)], method="none")
p.adjust(commListPs[c(3,4,8:10)], method="fdr")
contact_holm <- p.adjust(commListPs[c(3,4,8:10)], method="holm")
