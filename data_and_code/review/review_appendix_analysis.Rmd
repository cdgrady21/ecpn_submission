...
People aware/used QIP, people aware/used borehole.
...
Benue pastoralists less benefit because migration
...
# benue pastoralist differences?e
## chris: is this reg correct?  Or should it just be all benue pastoralists?  Or should it only be TR Ben pastoralists (rather than TR interaction)?
ag.df$ben_past <- ifelse(ag.df$state %in% "ben" & ag.df$farm_past %in% "past", 1, 0)
lm_robust(attitude_cw~ben_past*treatment,
