...
Now NPC (NPC now defunct, not on CRAN)
...
#analysis.fun(var=placebo_list[10])
...
strat.fun("violence_group.criminals_base")
vio1 <- true.fun1("vio_cw", "treatment")
...
**atts towards ppl from other religions**

```{r}
# other religions
strat.fun("outgroup_atts_group.trust_rel_base")
rel1 <- true.fun1("outgroup_atts_group.trust_rel", "treatment")
```
...
```{r}
# radio
strat.fun("radio_base")
rad1 <- true.fun("radio", "treatment")
