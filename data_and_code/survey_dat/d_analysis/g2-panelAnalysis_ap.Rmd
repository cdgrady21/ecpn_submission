...
(p_threat_trust <- true.fun('allTrust_cw', 'threat_cw'))
(p_threat_contact <- true.fun('contactOnly_cw', 'threat_cw'))
(p_threat_in <- true.fun('in_cw', 'threat_cw'))
```
...
(p_emp_trust <- true.fun1('allTrust_cw', 'emp_cw'))
(p_emp_contact <- true.fun1('contactOnly_cw', 'emp_cw'))
(p_emp_in <- true.fun1('in_cw', 'emp_cw'))
...
(p_persp_trust <- true.fun1('allTrust_cw', 'persp_cw'))
(p_persp_contact <- true.fun1('contactOnly_cw', 'persp_cw'))
(p_persp_in <- true.fun1('in_cw', 'persp_cw'))
...
(p_expand_trust <- true.fun('allTrust_cw', 'expand_cw'))
(p_expand_contact <- true.fun('contactOnly_cw', 'expand_cw'))
(p_expand_in <- true.fun('in_cw', 'expand_cw'))
